...
process.onStart(function(this)
    ...
    local footman1 = Unit(TPL_UNIT.HeroFlameLord, Player(1), 0, 0, 270)
    --.period(1000).primary("agi")
    --.lightningPush(Lighting(LIGHTING_TYPE.thunderRed))

    local footman2 = Unit(TPL_UNIT.Footman, Player(2), 0, 0, 270)
    --让人物动起来
